    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="hero-textarea">
          <h1 class="hero-textarea__hdr">Make The First Move.</h1>
          <p class="hero-textarea__para">Serviced offices available to rent in London, Manchester and Leeds from <span>incspaces.</span></p>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="row">
            <div class="col-xs-4 c">
              <div class="image-tiles-heading">
                <h2 class="image-tiles-heading__hdr">Some of our spaces.</h2>
              </div>
            </div>
            <div class="col-xs-4 c">
